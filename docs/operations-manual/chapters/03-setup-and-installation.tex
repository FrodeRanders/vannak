...
\texttt{VANNAK\_PG\_INTEGRATION=1}, and, when \texttt{--cluster} is given,
builds the node image, brings up the three nodes, waits for leader election,
and probes each node.
