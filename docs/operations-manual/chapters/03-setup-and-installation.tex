...
\texttt{raft} & \texttt{gautelis-graft-core}, \texttt{serde}, \texttt{serde\_json} \\
\texttt{sitas-runtime} & local \texttt{sitas} crate \\
\texttt{kafka-client} & \texttt{sitas-runtime} plus \texttt{rdkafka} \\
\texttt{node} & \texttt{raft} plus \texttt{gautelis-graft-runtime}, \texttt{gautelis-graft-storage}, \texttt{gautelis-graft-transport}, \texttt{gautelis-graft-proto}, \texttt{tokio}, \texttt{parking\_lot}, \texttt{bytes} \\
\hline
\end{tabular}
